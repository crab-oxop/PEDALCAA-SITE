...
export function WorkGallery({ images }: { images: GalleryImage[] }) {
  ...
  return (
    ...
    >
      <div className="relative aspect-[4/3] w-full overflow-hidden bg-gradient-to-br from-charcoal to-void sm:aspect-[16/9]">
        {images.map((img, i) => (
          <Image
            key={img.src}
            src={img.src}
        ...
        <p className="absolute bottom-6 left-6 text-sm text-ink sm:bottom-8 sm:left-8">
